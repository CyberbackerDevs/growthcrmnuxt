    ...
    <div class="col-xl-6">
        ...
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-5">PTO Request</a>
                ...
                <div>
                    <div class="d-flex align-items-center mb-8" v-for="n in 8">
                        <!--begin::Bullet-->
                        <span class="bullet bullet-vertical h-40px bg-danger user_bar"></span>
                        <!--end::Bullet-->
                        <!--begin::Checkbox-->
                        <!--end::Checkbox-->
                        <!--begin::Description-->
                        <div class="flex-grow-1">
                            <a href="#" class="text-gray-800 text-hover-primary fw-bolder fs-6">John Peter Doe</a>
